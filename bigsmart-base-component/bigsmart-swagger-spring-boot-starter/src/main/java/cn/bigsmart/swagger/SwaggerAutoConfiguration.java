...
@ConditionalOnProperty(name = "bigsmart.swagger.enabled", havingValue = "true", matchIfMissing = true)
...
public class SwaggerAutoConfiguration {
    ...
    public Docket docketApi(SwaggerProperties swaggerProperties) {
        ...
        Docket defaultDocket = new Docket(DocumentationType.OAS_30)
                ...
                .paths(PathSelectors.regex("/dispatcher-servlet/initialize").negate())
